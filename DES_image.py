...
def encrypt(message, keyfromfile, outfi):
    ...
    while (bv.more_to_read):
        ...
        if bitvec._getsize() > 0:
            ...
            final_string.write_to_file(opout)
           

if __name__ == "__main__":
    out = encrypt(sys.argv[1], sys.argv[2], sys.argv[3])
